...
export default function Hero() {
  ...
  return (
    <section className="bg-[#F8F0EB] min-h-[100svh] flex items-center overflow-x-hidden px-4 sm:px-6 py-20 sm:py-24 lg:py-36">
      <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center justify-between w-full gap-12 lg:gap-20">
        ...
        >
          <h1
            className="
              ...
              max-w-full mx-auto pb-4 sm:pb-2
            "
            style={goldText}
          >
            <span className="block whitespace-nowrap pb-1">{t.hero.groom}</span>
            <span className="block text-5xl sm:text-6xl md:text-7xl leading-[0.9] py-1">&</span>
            <span className="block whitespace-nowrap pb-4 sm:pb-3">{t.hero.bride}</span>
          </h1>
        ...
        <div className="grid grid-cols-2 gap-3 w-full lg:w-1/2 overflow-hidden">
          <img src="/images/img1.jpg" alt="img1" className="w-full aspect-[3/4] object-cover rounded-xl animate-floating-fast delay-0" />
          <img src="/images/img2.jpg" alt="img2" className="w-full aspect-[3/4] object-cover rounded-xl animate-floating-medium delay-200" />
          <img src="/images/img3.jpg" alt="img3" className="w-full aspect-[5/3] object-cover rounded-xl col-span-2 animate-floating-slow delay-400" />
        </div>
      </div>
    </section>
  );
