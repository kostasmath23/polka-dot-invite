...
export default function Timer() {
  const weddingDate = new Date('2025-09-27T17:30:00');
  ...
  const renderer = ({ days, hours, minutes, seconds }) => (
    <section className="bg-[#eae6df] py-24 px-4 sm:px-6">
      <div className="bg-white shadow-2xl max-w-screen-xl mx-auto rounded-2xl py-20 sm:py-24 px-6 sm:px-16 text-center overflow-hidden">
        <div className="flex justify-center flex-wrap gap-6 sm:gap-10 text-[#306844] text-5xl sm:text-6xl md:text-7xl font-light leading-tight">
